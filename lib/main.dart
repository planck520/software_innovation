    ...
    return GestureDetector(
      onTap: () => Navigator.push(
        ...
        TechPageTransitions.iosSlide(builder: (c) => InterviewChatPage(
          ...
          showHintsAfterAnswer: showHintsAfterAnswer,
...
class ReportPage extends StatelessWidget {
              ...
              LineChartData(
                ...
                gridData: FlGridData(
                  ...
                  getDrawingHorizontalLine: (_) {
                    return FlLine(color: AppColors.border.withOpacity(0.25), strokeWidth: 1);
                  },
                ),
  ...
  List<FlSpot> _buildLinearFitSpots(List<int> values) {
    ...
    return [
      for (int i = 0; i < values.length; i++) FlSpot(i.toDouble(), slope * i + intercept),
    ];
  }
